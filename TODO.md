...
- [ ] **G4. `chat.py` tax explainer prompt** [owner: claude] [priority: p1] [state: in-progress] [unblocks: Q8] has no product constraints (EIS/SEIS content invites investment-product suggestions) and no temperature; tighten before go-live (Q8 promises it).
