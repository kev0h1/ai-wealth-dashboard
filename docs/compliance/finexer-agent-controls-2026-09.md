...
- Dependency vulnerability audit, dated 2026-09-10. Backend (`pip-audit` 2.10.1, 81 pkgs): 0 known advisories. Frontend production (`npm audit --omit=dev`): re-audited 2026-09-11, no production advisories; the moderate baseline-browser-mapping advisory found on 2026-09-10 was resolved by lifting the transitive dependency. Full `npm audit` incl. dev tooling: 5 advisories (1 low, 1 moderate, 3 high), all dev-only, never shipped. No Critical or High shipped to production.
