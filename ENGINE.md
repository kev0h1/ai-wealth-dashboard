...
2. **LLM judgement** — the existing name-check / classify pass on the Haiku tier (`llm_name_check`, `categorise_others_bg` in `categorisation.py`, `anthropic/claude-haiku-4-5`). Cheap, for routine ambiguity.
