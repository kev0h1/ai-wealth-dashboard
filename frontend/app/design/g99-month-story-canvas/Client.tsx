...
export default function Client() {
  ...
  return <main className={`min-h-dvh ${dark ? "bg-[#0f172a] text-slate-100" : "bg-[#f0f2f7] text-slate-950"} selection:bg-indigo-200`}>
