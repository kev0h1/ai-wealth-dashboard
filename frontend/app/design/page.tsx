...
const ROUTES: PreviewRoute[] = [
  ...
  },
  {
    ...
    description:
      "G57 replacement Spend revamp after Kevin rejected the first round as more of the same · three genuinely different work models against the owner-shaped reconciled figures (£4,976 Out = £3,140 in three attention categories + £1,496 across eleven quieter categories + £340 unplaced; £8,087 Moved stays separate and neutral): A Pay-period journey makes the page one continuous story and now visibly reconciles £1,730 more across three categories less a £144 offset elsewhere to the £1,586 overall pace difference, separates payment evidence from the equal One-off / New normal choices, adds a mobile and desktop jump strip, and restores Charts and patterns with the real production pace chart plus a route to all seven chart views; B Next decision uses a wayfinding model where Review changes, Place payments, Browse all spending, Follow moved money and Compare periods are distinct destinations, showing one useful workspace at a time; C Category field makes category amount spatial, keeps every category visible without an eleven-row tail, and uses one persistent focus panel while retaining Across periods as a separate analytical view · preview-only fixture data, no API calls or production edits · ?variant=a|b|c&mode=light|dark",
  ...
  },
  {
    ...
    name: "your-plan",
    description:
      "B19/B21: five-tier plan-picker · approved A capability ladder now uses the production PlanPicker with monthly, 6-month and yearly renewal choices plus a 14-day annual trial · B full plan cards and C needs-first rows retained for comparison · Settings and onboarding contexts · light/dark modes · billing off/on states · preview-only fixtures, no plan or payment changes",
    states: [
