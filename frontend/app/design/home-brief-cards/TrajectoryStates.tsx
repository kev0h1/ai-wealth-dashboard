  ...
  return (
    <section aria-label="Debt trajectory states">
      <PreviewHeading
        ...
        copy="The card now leads on how much more or less is owed over a named window, and says the direction in words. The carried total drops to the last line of the body. A rising balance on 0% is worded and marked differently from one being charged interest, and the green mark is only reachable when the balance is falling, nothing on it is charging interest, and no 0% end date is on file."
      />
      ...
      <p className="mx-auto mb-4 max-w-[430px] text-pretty text-[13px] leading-5 text-slate-600 dark:text-slate-300 lg:max-w-none">
        Every string is generated by the backend, not written here. Two backend tests re-derive all eight from the live
        function and fail if any of them drifts, or if a ninth is hand-added beside them.
      </p>
