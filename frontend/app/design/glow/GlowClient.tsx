...
const GLOW_STYLE: Record<Variant, React.CSSProperties | null> = {
  A: {
    background: [
    ...
    <div className="min-h-dvh bg-[#f0f2f7] pb-40">
      ...
      <div className="max-w-lg mx-auto px-4 pt-6 space-y-10">
        ...
        <div>
          ...
          <h2 className="text-lg font-bold text-slate-900 mb-1">Light-mode glow</h2>
        ...
        <div className="glass-card rounded-2xl w-full min-h-[44px] px-4 py-3 flex items-center justify-between gap-3">
          ...
          <ChevronRight size={16} aria-hidden="true" className="flex-shrink-0 text-slate-400" />
        </div>
        ...
        <div className="hero-arrive rounded-3xl p-5 glass-hero">
          <div className="flex items-center gap-1.5 mb-3">
            ...
            <AlertCircle size={14} className="text-amber-500 flex-shrink-0" aria-hidden="true" />
          </div>
            ...
            <div className="space-y-2">
              <div className="grid grid-cols-3 gap-2">
                <div className="flex flex-col gap-0.5 items-start rounded-xl glass-tile px-3 py-2.5">
                  <span className="text-[11px] font-semibold uppercase tracking-wide text-slate-400 text-left">Now</span>
                  <span className="text-base font-semibold text-slate-800 tabular-nums num text-left">£471</span>
                </div>
                <div className="flex flex-col gap-0.5 items-start rounded-xl glass-tile px-3 py-2.5">
                  <span className="text-[11px] font-semibold uppercase tracking-wide text-slate-400 text-left">Bills</span>
                  <span className="text-base font-semibold text-slate-800 tabular-nums num text-left">−£172</span>
                </div>
                <div className="flex flex-col gap-0.5 items-start rounded-xl glass-tile px-3 py-2.5">
                  <span className="text-[11px] font-semibold uppercase tracking-wide text-slate-400 text-left">Free</span>
                  <span className="text-base font-semibold tabular-nums num text-left text-amber-500">£299</span>
                </div>
              </div>

              <div className="w-full rounded-xl glass-tile px-3 py-2.5 flex items-center justify-between gap-3 text-left">
                <p className="flex flex-wrap items-baseline gap-x-1.5 gap-y-0.5">
                  <span className="text-base font-semibold tabular-nums num text-slate-600">£299</span>
                  <span className="text-[13px] text-slate-500">free</span>
                  <span className="text-[13px] text-slate-400" aria-hidden="true">·</span>
                  <span className="text-base font-semibold tabular-nums num text-emerald-600">£421</span>
                  <span className="text-[13px] text-slate-500">paid off credit cards</span>
                </p>
                <span className="text-slate-400 text-sm flex-shrink-0" aria-hidden="true">›</span>
              </div>
            </div>

            <div className="space-y-1">
              <p className="text-[13px] text-slate-500 num">£10.50/day until pay period end</p>
              <p className="text-sm text-slate-500 num">Pay period ends Friday · ~£1,850 expected</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-2xl glass-card px-4">
          <div className="w-full min-h-[44px] flex items-center justify-between py-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-slate-600">How your money behaves</span>
            </div>
        ...
        <div className="glass-card rounded-2xl px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-xs text-slate-400 font-medium">Coming up · 14 days</p>
            <div className="flex items-center gap-2 flex-wrap mt-0.5">
              <span className="text-sm font-semibold text-amber-500">2 due tomorrow</span>
              <span className="text-sm font-semibold text-slate-600">3 bills over the next 2 weeks</span>
            </div>
          </div>
          <div className="text-right flex-shrink-0">
            <p className="text-xs text-slate-400">total out</p>
            <p className="text-sm font-bold text-slate-700 num">£172</p>
          </div>
        </div>
      </div>

      {/* ── Variant switcher — fixed bottom-centre ────────────────────────── */}
      <div
        className="fixed bottom-4 left-1/2 -translate-x-1/2 z-40 flex flex-col items-center gap-2 px-4"
        style={{ marginBottom: "env(safe-area-inset-bottom)" }}
      >
        <p className="text-xs text-slate-500 bg-white/90 backdrop-blur rounded-full px-3 py-1 border border-slate-200 shadow-sm text-center max-w-xs">
          {CAPTIONS[variant]}
        </p>
        <div className="bg-white/90 backdrop-blur border border-slate-200 rounded-full p-1 shadow-sm flex items-center gap-1">
