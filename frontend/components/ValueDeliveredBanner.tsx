      ...
      <div className="flex items-center gap-3 bg-indigo-600 rounded-2xl px-4 py-3 shadow-sm active:scale-[0.98] transition-transform">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm font-bold text-white leading-tight">
            <span className="font-mono tabular-nums">{sym}{monthly.toLocaleString("en-GB", { maximumFractionDigits: 0 })}</span>/mo saved
            {" "}<span className="font-normal text-white/80">· <span className="font-mono tabular-nums">{sym}{annual.toLocaleString("en-GB")}</span>/yr</span>
          </p>
        </div>
