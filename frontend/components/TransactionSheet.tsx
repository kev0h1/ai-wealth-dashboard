...
export default function TransactionSheet({
  ...
  return (
    <>
      ...
      {/* Sheet */}
      <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[430px] bg-white dark:bg-slate-800 rounded-t-3xl z-[70] slide-up overflow-y-auto max-h-[88vh]">
        {/* Handle */}
        ...
        <div className="px-5 pt-5 pb-4">
          ...
          <select
            ...
            className="w-full border border-slate-200 dark:border-slate-600 rounded-xl px-3 py-3 text-sm text-slate-800 dark:text-slate-100 bg-slate-50 dark:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent appearance-none"
          >
